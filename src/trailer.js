...
export const Trailers = [
  ...
  },
  {
    ...
    date: 'See more',
    Description:
      ' We take the time to learn your cross-border supply chain, then build capacity solutions with trusted providers to help execute it. KALWAY can facilitate every step of the cross-border process, from sourcing carriers to coordinating with customs brokers on your behalf. ',
  },
];
